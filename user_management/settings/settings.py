...
DATABASES = {
    'default': {
        ...
        'NAME': config('DURT_DB_NAME'),
        'USER': config('DURT_DB_USER'),
        'PASSWORD': config('DURT_DB_PASSWORD'),
        'HOST': config('DURT_DB_HOST'),
        'PORT': config('DURT_DB_PORT'),
...
EMAIL_USE_TLS = True
DEFAULT_FROM_EMAIL = config('EMAIL_USER_DEFAULT')
